...
const App = () => {
  ...
  const getUserList = () => {
    ...
    axios.get('weather-app-eevee.herokuapp.com/api/forecast')
  ...
  const getCityInfo = (cityName) => {
    ...
    axios.get('weather-app-eevee.herokuapp.com/api/info/' + cityName)
  ...
  const handleCreate = (addCity) => {
    axios.post('weather-app-eevee.herokuapp.com/api/forecast', addCity)
    .then((res) => {
  ...
  const handleDelete = (event) => {
    axios.delete('weather-app-eevee.herokuapp.com/api/forecast/' + event.target.value)
    .then((response) => {
      getUserList()
    })
  }
  ...
  const handleUpdate = (editNote) => {
    axios.put('weather-app-eevee.herokuapp.com/api/forecast/' + editNote.id, editNote)
    .then((response) => {
      getUserList()
    })
  }
